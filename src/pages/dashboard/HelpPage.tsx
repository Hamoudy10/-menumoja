...
import {
  ...
  Mail, Phone, Video, FileText, ArrowRight,
} from 'lucide-react'
const Youtube = Video
...
const faqs = [
  ...
  { q: 'Can I customize my QR code?', a: 'Yes, visit Settings > QR Manager to choose from different QR code styles.' },
  ...
  { q: 'What happens when I delete my account?', a: 'All data is permanently deleted. This action cannot be undone. Please export any data first.' },
]

const tutorials = [
  { title: 'Getting Started with MenuMoja', duration: '4:30', views: '12K' },
  { title: 'How to Manage Your Menu', duration: '6:15', views: '8K' },
  { title: 'Processing Orders & Payments', duration: '5:45', views: '6K' },
  { title: 'AI Marketing Setup Guide', duration: '7:20', views: '3K' },
]
...
export default function HelpPage() {
  ...
  const handleAiSend = () => {
    ...
    setTimeout(() => {
      setAiChat((prev) => [...prev, {
        role: 'ai',
        content: 'Great question! Let me help you with that. Our team typically responds within 2 hours, but let me provide some immediate assistance...',
      }])
    }, 1000)
    setAiMessage('')
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-heading text-2xl font-bold text-text-primary dark:text-white">Help & Support</h1>
          <p className="font-body text-sm text-text-secondary dark:text-white/50">Get help, search guides, or contact support</p>
        </div>
        <motion.button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="rounded-2xl bg-white dark:bg-primary-light border border-white/10 p-5">
          <h3 className="font-heading text-lg font-bold text-text-primary dark:text-white mb-4">FAQ</h3>
        ...
        <div className="space-y-6">
          <div className="rounded-2xl bg-white dark:bg-primary-light border border-white/10 p-5">
            <h3 className="font-heading text-lg font-bold text-text-primary dark:text-white mb-4">Video Tutorials</h3>
            <div className="space-y-3">
              {tutorials.map((t) => (
                <div key={t.title} className="flex items-center gap-3 p-3 rounded-xl hover:bg-black/5 dark:hover:bg-white/5 transition-colors cursor-pointer group">
                  <div className="flex h-12 w-16 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-secondary/20 to-accent/20">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      <span className="font-accent text-xs text-text-secondary dark:text-white/50">{t.duration}</span>
                      <span className="font-accent text-xs text-text-secondary dark:text-white/50">·</span>
                      <span className="font-accent text-xs text-text-secondary dark:text-white/50">{t.views} views</span>
                    </div>
                  </div>
          ...
          <div className="rounded-2xl bg-white dark:bg-primary-light border border-white/10 p-5">
            <h3 className="font-heading text-lg font-bold text-text-primary dark:text-white mb-4">Contact Support</h3>
            <div className="space-y-3">
              ...
              <div>
                <label className="mb-2 block font-accent text-sm font-medium text-text-primary dark:text-white/90">Message</label>
                <textarea
      ...
      <div className="rounded-2xl bg-gradient-to-br from-primary to-primary-light p-6 text-white">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h3 className="font-heading text-lg font-bold">Need Immediate Help?</h3>
            <p className="font-body text-sm text-white/70 mt-1">Our support team is available 24/7</p>
          </div>
